...
import { useLoaderData, useActionData, useNavigation, Form, Link } from "react-router-dom";
      ...
      <Form method="post">
        <div className="form-group">
          ...
          <input
            ...
            id="title"
            name="title"
            defaultValue={actionData?.values?.title || book.title}
            required
        ...
        <div className="form-group">
          ...
          <input
            ...
            id="author"
            name="author"
            defaultValue={actionData?.values?.author || book.author}
            required
            className="form-input"
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            step="0.01"
            min="0"
            defaultValue={actionData?.values?.price || book.price}
            required
            className="form-input"
          />
        ...
        <div className="form-group">
          ...
          <textarea
            id="description"
            name="description"
            defaultValue={actionData?.values?.description || book.description || ""}
        ...
        <div className="form-group">
          ...
          <input
            ...
            defaultValue={actionData?.values?.image || book.image || ""}
            className="form-input"
          />
        </div>
        ...
        <div className="form-buttons">
          ...
          >
            ✏️ {isSubmitting ? "Updating..." : "Update Book"}
          </button>
          <button 
            type="submit" 
            name="intent" 
            value="delete"
            disabled={isSubmitting}
            className="form-button delete-form-button"
          >
            🗑️ {isSubmitting ? "Deleting..." : "Delete Book"}
          </button>
          <Link 
            to="/admin"
